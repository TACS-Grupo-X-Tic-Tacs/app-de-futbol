export const comandoAyuda = (bot) => msg => {
  ...
  \n/inscribirse [idPartido],[nombre y apellido],[mail],[telefono]' -> Escribiendo un id, nombre y apellido, mail y un telefono puede inscribirse en el partido que desee. Por ejemplo: /inscribirse 5,Pepe Rodriguez,peperodriguez@mail.com,112374637
